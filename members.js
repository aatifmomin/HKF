...
import { peekNextMemberId, newPendingMemberKey, recalcMemberTotal } from "./members-self.js?v=2026-09-02b";
...
function renderAdminDirectory(container) {
  ...
  exportBtn.addEventListener("click", async () => {
    ...
    try {
      const mod = await import("./members-export.js?v=2026-09-02b");
