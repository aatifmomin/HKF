...
import { peekNextMemberId, newPendingMemberKey, recalcMemberTotal } from "./members-self.js?v=2026-09-02c";
import { getSelectedYear, onYearChange } from "./year-state.js?v=2026-09-02c";
...
function renderAdminDirectory(container) {
  ...
  exportBtn.addEventListener("click", async () => {
    ...
    try {
      const mod = await import("./members-export.js?v=2026-09-02c");
